...
func CriarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if erro = usuario.Preparar(modelos.EtapaCadastro); erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
func BuscarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	usuario, err := repositorio.BuscarUsuario(usuarioID)
	if err != nil {
	...
	if usuario.Id == 0 {
		respostas.JSON(w, http.StatusNotFound, usuario)
		return
	}
...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if uint64(usuarioID) != usuarioIDToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("operação não permitida"))
		return
	}
	...
	if erro = usuario.Preparar(modelos.EtapaEditar); erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
func DeletarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	usuarioId, erro := strconv.ParseInt(parametro["usuarioId"], 10, 64)
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("não é possível mudar a senha de um usuário que não seja o seu"))
		return
	}
